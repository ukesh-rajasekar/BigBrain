...
const EditQuestion = (props) => {
  ...
  const [currentDetails, setCurrentDetails] = useState(getNewObject({}));
  ...
  const handleSave = () => {
    ...
    if (answer.value.length > max || answer.value.length < min) {
      alert('Answer should be of length between 2 and 6 character');
    } else {
